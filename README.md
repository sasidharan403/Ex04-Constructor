...
class TestEmployee
{
    ...
    {
        Employee e1 = new Employee("Hari", "Tester", 15, 5000, 200);
        e1.sal();
        Employee e2 = new Employee("akask", "Developer", 10, 3000, 200);
        e2.sal();
        e1.display();
        e2.display();
...
~~~
 ...
 ## Output:
 ![image](https://github.com/sasidharan403/Ex04-Constructor/assets/94154712/0d374f75-968f-4880-872d-c3c100579032)
